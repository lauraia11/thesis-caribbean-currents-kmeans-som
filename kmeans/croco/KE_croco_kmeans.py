...
# Carga de componentes U y V
with h5py.File(r'C:/LAURA/CROCOFINALFINAL/arrays_u_final1.mat', 'r') as file:
    up = file['array_upt'][:]
with h5py.File(r'C:/LAURA/CROCOFINALFINAL/arrays_v_final1.mat', 'r') as file:
    vp = file['array_vpt'][:]
...
nclust = 9
indx = K[:, nclust - 1]
KE_clust_reshaped = np.zeros((nclust, 295, 469))
